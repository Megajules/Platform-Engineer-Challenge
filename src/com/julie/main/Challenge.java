...
import com.julie.dbConnect.ReplicaSet;
...
public class Challenge extends Thread {
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length > 0) {
			...
			url = "D:\\Workspaces\\Platform Engineer Challenge\\src\\com\\julie\\main\\partfile.txt";
			dbname = "challengeDb";
			collname = "wordsCollection";
			host = "localhost";
		...
		DisplayConsole console = new DisplayConsole(dbname,collname);
		console.menuOptions();
	}
